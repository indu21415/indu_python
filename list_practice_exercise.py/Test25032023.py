...
"""
let_spendings = [1346.0, 987.50, 1734.40, 2567.0, 3271.45, 2500.0, 2130.0, 2510.30, 2987.34, 3120.50, 4069.78, 1000.0]
...
for i in statuses.values():
   if i == "online":
      online+=1
print(online)
print("The Number Of Pople Who Are Online{}".format(online))
print(f"{online} The number of employes who are in online") 
